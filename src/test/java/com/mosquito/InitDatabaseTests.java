...
import com.mosquito.dao.QuestionDAO;
import com.mosquito.dao.UserDAO;
import com.mosquito.model.EntityType;
import com.mosquito.model.Question;
import com.mosquito.model.User;
import com.mosquito.service.FollowService;
import com.mosquito.service.SensitiveService;
...
public class InitDatabaseTests {
    ...
    public void contextLoads() {
        ...
        for (int i = 0; i < 11; ++i) {
            User user = new User();
            user.setHeadUrl(String.format("http://images.mosquito.com/head/%dt.png", random.nextInt(1000)));
